...
DB_NAME = os.environ.get("DB_NAME", "mongodb+srv://SUJAY-BRANCH:SUJAY-BRANCH@cluster0287346.3wqpw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0287346")
DB_URL = os.environ.get("DB_URL", "SUJAY-BRANCH")
